...
<img src = "assets/UCI14_2Line_ICS_Dept_Stats_blue.png" width="55%"/><img src = "assets/UCi17_CtrVirusResearch_blue.png"/ width="40%">

#### Contact information: 
For technical details get in touch with  [Prof. Vladimir Minin](http://vnminin.github.io). For more general media inquiries, contact [Prof. Andrew Noymer](https://webfiles.uci.edu/noymer/web/).
