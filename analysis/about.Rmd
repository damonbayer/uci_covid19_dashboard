...
<img src = "assets/UCI14_2Line_ICS_Dept_Stats_blue.png" width="60%"/>&nbsp;&nbsp;&nbsp;<img src = "assets/UCI14_FLS_PubHealth_Blue.png"/ width="35%">

<img src = "assets/UCi17_CtrVirusResearch_blue.png"/ width="37%">
...
Please get in touch if you would like to contribute to this effort.

#### Contact information: 
If you would like to know more about technical details and/or joining the group, get in touch with  [Prof. Vladimir Minin](http://vnminin.github.io). For general media inquiries contact [Prof. Andrew Noymer](https://webfiles.uci.edu/noymer/web/).
...
The content of this cite is licensed under the most permissive creative commons license (click on License tab in the navigation bar to learn more). 
