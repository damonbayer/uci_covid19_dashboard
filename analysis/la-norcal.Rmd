...
#### Use <span style="color:#FFF; background-color: #0064A4">CA County Trends</span> dropdown menu for other county comparisons
...
counties_of_interest <- c("Los Angeles", "Alameda", "Santa Clara", "Sacramento", "Contra Costa")
